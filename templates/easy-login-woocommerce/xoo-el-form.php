...
<div class="woo-login-popup-sc-modal woo-login-popup-sc-modal-off xoo-el-form-container xoo-el-form-<?php echo esc_attr( $args['display'] ); ?>" data-active="<?php echo esc_attr( $form_active ); ?>">
	...
	<?php foreach ( $args['forms'] as $form => $form_args ): ?>
		...
		<div data-section="<?php echo esc_attr( $form ) ?>" class="xoo-el-section">
			...
			<div class="xoo-el-fields">
				...
				<form class="<?php echo esc_attr( $form ); ?> xoo-el-action-form xoo-el-form-<?php echo esc_attr( $form ); ?>">
